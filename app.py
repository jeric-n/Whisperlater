...
try:
    ...
    if torch.cuda.is_available():
        logging.info("Moving VAD model to GPU...")
        vad_model.to("cuda")
...
def transcribe():
    ...
    try:
        ...
        # --- VAD SETTINGS (TUNED FOR NOISY BACKGROUNDS) ---
        ...
        # --- WHISPER SETTINGS (TUNED FOR NOISY AUDIO & ACCURACY) ---
        ...
        logging.info(
            f"Starting transcription with tuned options: {fw_transcribe_options}"
        )
